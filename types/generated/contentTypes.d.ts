...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Catagory: Attribute.Enumeration<
      ['Eagle Project', 'Community Service', 'Recruitment', 'Fundraiser']
    >;
    tags: Attribute.Component<'events.tags', true>;
    Author: Attribute.String;
    slug: Attribute.UID<'api::event.event', 'Title'>;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    startingTime: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTroopLeaderTroopLeader extends Schema.CollectionType {
  collectionName: 'troop_leaders';
  info: {
    singularName: 'troop-leader';
    pluralName: 'troop-leaders';
